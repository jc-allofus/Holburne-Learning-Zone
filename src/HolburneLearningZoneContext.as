package
{
	...
	import com.allofus.holburne.learningzone.view.homepage.HomePageMediator;
...
//			mediatorMap.mapView(HomepageSingleClickVC, HomePageMediator);
			mediatorMap.mapView(HomepagePaintingsOnly, HomePageMediator);
