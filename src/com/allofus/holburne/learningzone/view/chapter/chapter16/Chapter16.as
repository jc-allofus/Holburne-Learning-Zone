package com.allofus.holburne.learningzone.view.chapter.chapter16
{
	 ...
	 * @author jc
	 */
	public class Chapter16 extends AbstractChapterView
	{
		
		public function Chapter16(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter16 );
	}
}
