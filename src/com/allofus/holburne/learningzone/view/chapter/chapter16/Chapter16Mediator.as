package com.allofus.holburne.learningzone.view.chapter.chapter16
{
	 ...
	 * @author jc
	 */
	public class Chapter16Mediator extends AbstractChapterMediator
	{
		
		[Inject] public var model:Chapter16Model;
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter16Mediator );
