package com.allofus.holburne.learningzone.view.chapter.chapter18
{
	 ...
	 * @author jc
	 */
	public class Chapter18 extends AbstractChapterView
	{
		
		public function Chapter18(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter18 );
	}
}
