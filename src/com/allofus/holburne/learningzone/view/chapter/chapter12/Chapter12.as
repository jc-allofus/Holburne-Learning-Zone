package com.allofus.holburne.learningzone.view.chapter.chapter12
{
	 ...
	 * @author jc
	 */
	public class Chapter12 extends AbstractChapterView
	{
		
		public function Chapter12(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter12 );
	}
}
