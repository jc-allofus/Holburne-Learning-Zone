package com.allofus.holburne.learningzone.view.chapter.chapter19
{
	 ...
	 * @author jc
	 */
	public class Chapter19 extends AbstractChapterView
	{
		
		public function Chapter19(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter19 );
	}
}
