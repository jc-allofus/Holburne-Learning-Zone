package com.allofus.holburne.learningzone.view.chapter.chapter13
{
	 ...
	 * @author jc
	 */
	public class Chapter13 extends AbstractChapterView
	{
		
		public function Chapter13(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter13 );
	}
}
