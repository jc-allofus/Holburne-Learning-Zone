package com.allofus.holburne.learningzone.view.chapter.chapter06
{
	 ...
	 * @author jc
	 */
	public class Chapter06 extends AbstractChapterView
	{
		
		public function Chapter06(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter06 );
	}
}
