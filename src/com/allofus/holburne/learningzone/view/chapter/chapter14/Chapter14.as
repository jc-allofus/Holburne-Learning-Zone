package com.allofus.holburne.learningzone.view.chapter.chapter14
{
	 ...
	 * @author jc
	 */
	public class Chapter14 extends AbstractChapterView
	{
		
		public function Chapter14(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter14 );
	}
}
