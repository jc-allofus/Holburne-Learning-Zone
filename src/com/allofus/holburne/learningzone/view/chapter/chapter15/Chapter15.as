package com.allofus.holburne.learningzone.view.chapter.chapter15
{
	 ...
	 * @author jc
	 */
	public class Chapter15 extends AbstractChapterView
	{
		
		public function Chapter15(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter15 );
	}
}
