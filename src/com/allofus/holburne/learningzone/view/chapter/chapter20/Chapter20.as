package com.allofus.holburne.learningzone.view.chapter.chapter20
{
	 ...
	 * @author jc
	 */
	public class Chapter20 extends AbstractChapterView
	{
		
		public function Chapter20(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter20 );
	}
}
