package com.allofus.holburne.learningzone.view.chapter.chapter20
{
	 ...
	 * @author jc
	 */
	public class Chapter20Mediator extends AbstractChapterMediator
	{
		
		[Inject] public var model:Chapter20Model;
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter20Mediator );
