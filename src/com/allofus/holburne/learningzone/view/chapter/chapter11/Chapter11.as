package com.allofus.holburne.learningzone.view.chapter.chapter11
{
	 ...
	 * @author jc
	 */
	public class Chapter11 extends AbstractChapterView
	{
		
		public function Chapter11(vo:ChapterVO)
		{
			_chapterVO = vo;
...
//			_currentSelected.transitionInFromHomeScreen();
		...
		private static const logger:ILogger = GetLogger.qualifiedName( Chapter11 );
	}
}
