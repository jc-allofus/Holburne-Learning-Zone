package com.allofus.shared.text 
{
	...
	public class FontManager 
	{
		...
		public static function createStyledTextField(label : String, style : String = "copy", multi : Boolean = false, width:Number = 400, height:Number = 0, selectable:Boolean = false) : TextField
		{
			var field : TextField = new TextField();
			field.antiAliasType = AntiAliasType.ADVANCED;
			field.gridFitType = GridFitType.NONE;
